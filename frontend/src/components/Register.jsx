      ...
      <div className='w-full max-w-md'>
        <div className='bg-white rounded-2xl shadow-2xl p-8 md:p-10'>
          ...
          <div className='text-center mb-8'>
            <h2 className='text-3xl md:text-4xl font-bold text-[#008e9d] mb-2'>{t('register_title')}</h2>
            ...
            <div>
              ...
              <div className='relative'>
                ...
                <button
                  ...
                  className='absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-[#008e9d] transition'
                >
          ...
          <p className='text-center text-gray-600'>
            ...
            <Link to="/login" className='text-[#008e9d] font-semibold hover:underline mx-2'>
              {t('login')}
            </Link>
          </p>
        </div>
